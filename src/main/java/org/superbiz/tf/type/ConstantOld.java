...
public class ConstantOld<T> extends AbstractNode implements TFType, NamingSequence {
    private final T value;
    private Output<Object> output;

    public ConstantOld(T value, Attribute[] attributes) {
        super(attributes);
        this.value = value;
    }

    public static <T> ConstantOld of(T value, Attribute[] attributes) {
        return new ConstantOld(value, attributes);
    }
